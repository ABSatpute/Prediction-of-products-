    ...
    while True:
        try:
            ...
            if r.status_code == 429:
                ...
                backoff_time = min(backoff_time * 2, 64)  # Cap the backoff time to avoid excessively long delays
            else:
                raise
...
for i in range(1, 100):  # Adjust the range if necessary
    ...
    # Sleep for a variable time between 5 to 10 seconds to avoid hitting rate limits
...
output_path = "D:\\Web Scraping\\Scraped_Data.csv"
